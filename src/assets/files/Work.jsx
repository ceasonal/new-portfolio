    ...
    <div className="work-container cyber-razor-top cyber-razor-bottom bg-white">
      <div>
        <h1
          ...
          style={{ textAlign: "center", color: '#151412"' }}
        >
          Work Experience
        </h1>
      </div>
      <div>
        <VerticalTimeline lineColor="#151412" className="cyber-glitch-1">
          <VerticalTimelineElement
            ...
            icon={<LanguageIcon />}
          >
            <h3 className="vertical-timeline-element-title">Web Hosting</h3>
            <h4 className="vertical-timeline-element-subtitle">Internship</h4>
            <p>
              Did a one month internship in a web hosting company. Learned how
              to host and manage hosted websites aswell as fix & and help in new
              website creations for clients.
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <p>Check back later to see more experience of mine.</p>
          </VerticalTimelineElement>
        </VerticalTimeline>
      </div>
    </div>
